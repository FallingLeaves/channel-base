/**
 * @description 1.0.1版本：carousel组件，轮播；修复1.0.0版本的isAuto问题；具体查看类{@link Carousel}；<a href="./demo/components/carousel/1.0.1/slide/index.html">slide demo预览</a>
 * @module carousel
 * @author liweitao
 * @example
 * var Carousel = require('//static.360buyimg.com/mtd/pc/components/carousel/1.0.1/carousel.js');
 * var carousel = new Carousel({
 *   container: $('.threetpl_sale_carousel_main'),
 *   itemSelector: '.threetpl_sale_list',
 *   itemWidth: 1200,
 *   activeClass: 'on',
 *   startIndex: 0,
 *   duration: 300,
